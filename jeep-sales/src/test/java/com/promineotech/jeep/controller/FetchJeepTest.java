...
class FetchJeepTest {
  ...
  // start of extra test info from end of week 14 last video (deterministic testing) - around minute
  // 15:00 - can remove
  ...
  private List<Jeep> buildExpected() {
    List<Jeep> list = new LinkedList<>(); // week 14, video 2 (component scan issues and Lombok
                                          // coding, 24:00.
  //formatter:off
